...
\begin{enumerate}
  ...
  \item Vysvětlit specifika OT/ICS, SCADA a propojení fyzického a digitálního světa.
  \item Popsat typické kyberútoky na KI a jejich dopady.
  \item Vyložit ochranu: prevence, detekce, reakce, obnova, kontinuita, fyzická bezpečnost.
  \item Zopakovat atribuci a odstrašení v kontextu KI.
\end{enumerate}
...
Novější evropský přístup používá vedle kritické infrastruktury také jazyk kritických subjektů a odolnosti. Směrnice CER a česká transpozice posouvají důraz od pouhého seznamu objektů k tomu, aby subjekt zvládal rizika, kontinuitu a obnovu. Zákon o kybernetické bezpečnosti zase řeší kybernetickou rovinu regulovaných služeb. Tyto režimy se mohou překrývat: nemocnice může být důležitá zdravotní služba, regulovaný subjekt podle ZKB a zároveň správce osobních údajů podle GDPR.
...
Specifické jsou průmyslové systémy OT/ICS:
\begin{itemize}
...
\end{itemize}
Proto se ochrana OT nedá kopírovat z kancelářského IT. Potřebuje segmentaci, řízení vzdáleného přístupu, monitoring průmyslových protokolů, testované manuální režimy, bezpečnost změn a silnou spolupráci provozu s bezpečností.
...
\priklad{Útok na energetickou distribuční společnost nemusí okamžitě vypnout elektřinu. Může nejdřív mapovat síť, ukrást přístupy, narušit dohledové systémy a připravit možnost škody v době politické nebo vojenské krize.}
...
Atribuce u útoků na KI je politicky citlivá, protože veřejné přisouzení státu může znamenat eskalaci. Přesto je důležitá pro odstrašení: pokud útočník ví, že bude identifikován a ponese náklady, může si útok rozmyslet. U KI se kombinuje odstrašení odvetou a odstrašení znemožněním. Prakticky je nejdůležitější resilience: i když útok přijde, nesmí splnit strategický cíl.

\zkouska{U KI vždy řekni "nejde jen o data, ale o kontinuitu základní služby a fyzické dopady". To je hlavní rozdíl oproti běžnému IT incidentu.}

\zdroje{Přiložené PDF; směrnice CER 2022/2557; zákon č. 266/2025 Sb.; zákon č. 264/2025 Sb.; NÚKIB metodiky k regulovaným službám.}
