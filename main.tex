...
\subsection*{Kostra odpovědi}
\begin{enumerate}
  \item Odlišit kybernetickou bezpečnost, kyberobranu, kyberkriminalitu, kybernetický konflikt a kyberválku.
  \item Definovat kyberválku opatrně a vysvětlit vrstvy kyberprostoru, účinky operací a rozdíl vůči elektronickému boji.
  \item Popsat hlavní historické milníky a současné trendy.
  \item Identifikovat aktéry a vysvětlit problém atribuce.
  \item Vyložit možnosti odstrašení a základní rámec mezinárodního práva.
  \item Definovat netwar, typy sítí a swarming.
\end{enumerate}

\subsection*{Základní vymezení}
\textbf{Kybernetická bezpečnost} chrání systémy, data, služby a uživatele. \textbf{Kybernetická obrana} je vojenská a státně-obranná dimenze působení v kyberprostoru. \textbf{Kyberkriminalita} je trestná činnost spojená s informačními systémy nebo páchaná jejich prostřednictvím. \textbf{Kybernetický konflikt} je širší pojem zahrnující špionáž, sabotáž, nátlak, informační působení a operace pod prahem války.

Kyberválka je použití kybernetických operací státem nebo jiným politickým aktérem jako součást ozbrojeného konfliktu nebo k dosažení účinků srovnatelných se závažným vojenským útokem. Pojem nemá jednu všeobecně přijímanou hranici a jeho vymezení je odborně i právně sporné. Důležité je ale jedno pravidlo: většina kyberútoků není kyberválkou. Kyberšpionáž, běžný ransomware, DDoS nebo krádež dat mohou být velmi závažné, ale zpravidla zůstávají pod prahem ozbrojeného konfliktu.

Rozhodující je aktér, účel, rozsah, účinky a vztah k širšímu konfliktu. Jinak hodnotíme kriminální ransomware proti firmě, jinak státní špionáž proti ministerstvu a jinak destruktivní operaci, která je koordinována s konvenční vojenskou invazí.
...
Historii není potřeba odříkat jako katalog útoků. Stačí vybrat milníky, které změnily chápání kybernetického konfliktu. \textbf{Morrisův červ 1988} ukázal zranitelnost propojených sítí, ale nebyl kyberválkou. \textbf{Estonsko 2007} ukázalo politicky motivované rozsáhlé DDoS proti digitálnímu státu a problém atribuce. \textbf{Gruzie 2008} ukázala kybernetické útoky souběžně s konvenčním konfliktem. \textbf{Stuxnet} ukázal cílenou sabotáž průmyslového systému a překročení hranice mezi digitálním a fyzickým světem.

\textbf{Útoky na ukrajinskou energetiku 2015-2016} ukázaly zásah do kritické infrastruktury. \textbf{NotPetya 2017} ukázal destruktivní malware s globálními vedlejšími dopady. \textbf{SolarWinds} ukázal kompromitaci dodavatelského řetězce a dlouhodobou špionáž, nikoli automaticky kyberválku. \textbf{Ukrajina od roku 2022} ukazuje propojení wiperů, DDoS, satelitní komunikace, špionáže, informačních operací a konvenční války.

\subsection*{Současné trendy}
Dnešní kyberkonflikt se často odehrává pod prahem války. Typická je dlouhodobá špionáž, získávání přístupu pro budoucí konflikt, mapování kritické infrastruktury, pre-positioning, krádeže přístupových údajů a informační nebo vlivové operace. Útočník nemusí systém hned zničit; může si připravit přístup, který využije až v krizi.

\textbf{APT} je dobře organizovaný a dlouhodobě působící aktér, který cíleně proniká do vybraných systémů a snaží se v nich skrytě udržet přístup. Není nutné memorovat desítky názvů. \textbf{APT28} je veřejně spojován s ruskými státními zájmy a slouží jako příklad špionáže, politického tlaku a zneužívání infrastruktury třetích osob. \textbf{APT31} je v českém kontextu důležitý kvůli veřejné atribuci kampaně proti MZV ČR Čínské lidové republice. \textbf{Lazarus Group} se typicky spojuje se Severní Koreou a ukazuje propojení státních zájmů s finančně motivovanými operacemi. U všech těchto příkladů je nutné rozlišovat veřejnou atribuci, technické přiřazení a právně prokázanou odpovědnost.

\priklad{APT31 proti MZV ČR je dobrý příklad šedé zóny: podle české vlády šlo o dlouhodobou škodlivou kybernetickou kampaň spojovanou s ČLR, která cílila na neutajovanou síť MZV. Je to závažná bezpečnostní a diplomatická věc, ale sama o sobě to není automaticky kyberválka.}

U kritické infrastruktury je klíčový pre-positioning. Příklady jako Volt Typhoon ukazují, že cílem nemusí být okamžité vypnutí služby, ale tiché udržování přístupu v infrastruktuře pro budoucí krizi. Podobně útoky proti ukrajinské energetice nebo satelitním službám ukazují, že kyberoperace mohou mít strategický význam, pokud ovlivní komunikaci, energii nebo schopnost velení.

Stále větší význam mají cloud, identity a dodavatelské řetězce. Útočníci necílí jen na koncové počítače, ale na cloudové účty, autentizační tokeny, správní rozhraní, poskytovatele služeb, aktualizační mechanismy, telekomunikační sítě a okrajová zařízení. Nejde o frázi "hacknout cloud", ale o zneužití chybné konfigurace, kompromitované identity nebo závislosti na poskytovateli.

AI je hlavně zesilovač existujících metod. Zrychluje phishing, překlady, personalizaci sociálního inženýrství, deepfake audio a video, analýzu odcizených dat, průzkum a tvorbu skriptů. Bez spolehlivých důkazů není vhodné tvrdit, že už probíhá plně autonomní kyberválka bez lidské kontroly.

Hacktivismus a proxy aktéři zvyšují politickou viditelnost útoků. Hacktivisté jednají z politických nebo ideologických důvodů a často používají DDoS, úniky dat, defacement a informační kampaně. Mohou být spontánní, státem tolerovaní nebo státem využívaní jako proxy. Proruské DDoS skupiny, například NoName057(16), ukazují, že i technicky jednodušší útoky mohou působit reputační tlak a zahlcovat komunikaci organizací.

Obranné trendy stojí na sdílení threat intelligence, společných atribucích, sankcích, trestním stíhání, rozbíjení infrastruktury, zero trust, ochraně identit, segmentaci, zálohách, cvičeních, odolnosti, obnově a veřejně-soukromé spolupráci.
...
Atribuce má čtyři navazující roviny:
\begin{itemize}
  \item \textbf{technická} - malware, servery, účty, logy, indikátory kompromitace a další stopy,
  \item \textbf{operační} - způsob práce, cíle, nástroje a opakující se techniky,
  \item \textbf{strategická a zpravodajská} - motivace, geopolitický kontext a neveřejné informace,
  \item \textbf{politická a právní} - zda stát útok veřejně přisoudí a zda lze jednání právně přičíst jinému státu.
\end{itemize}

Hlavní problémy jsou VPN a proxy, botnety, kompromitovaná zařízení, infrastruktura třetích osob, sdílený nebo odcizený malware, falešné stopy, změněné časové údaje, false flag operace, rozdíl mezi pravděpodobností a jistotou a ochrana zpravodajských zdrojů. Výsledkem často není absolutní jistota, ale míra důvěry.

\priklad{Česká veřejná atribuce APT31 proti MZV ČR ukazuje, že politická atribuce je až konečný krok. Předchází jí technická analýza, zpravodajské hodnocení a strategické rozhodnutí, co lze zveřejnit a jaký bude diplomatický dopad.}
...
Praktické problémy odstrašení jsou přesně ty, které zdůrazňuje přednáška: dokážeme útok dostatečně spolehlivě přisoudit? Je hrozba reakce věrohodná? Je stanoven práh, kdy stát odpoví? Nezasáhneme nesprávný cíl? Nevyvolá reakce další eskalaci? Má protivník vůbec cíle, na které lze účinně působit? Jak se liší odstrašení státu, kriminální skupiny a hacktivistů? Může útočník nebo třetí strana znovu využít zveřejněnou zranitelnost? Lze stejnou kybernetickou schopnost použít opakovaně?
...
\priklad{Proruská hacktivistická DDoS kampaň může být dobrý příklad swarmingu: mnoho menších útoků míří na instituce, firmy nebo veřejné služby, zatímco komunikační kanály útočníků zveřejňují cíle, výsledky a propagandistický narativ. Technicky jde často o dostupnost, politicky o reputační a informační tlak.}

\zkouska{Kybernetická bezpečnost chrání systémy, data, služby a uživatele, kyberobrana je vojenská a státně-obranná dimenze, kyberkriminalita je trestná činnost a kybernetický konflikt je širší pojem pro špionáž, sabotáž, nátlak a informační působení. Kyberválka je užší: použití kybernetických operací státem nebo politickým aktérem jako součást ozbrojeného konfliktu nebo k dosažení účinků srovnatelných se závažným vojenským útokem. Většina kyberútoků není kyberválkou; záleží na aktérovi, účelu, rozsahu, účincích a vztahu k širšímu konfliktu. Kyberprostor má fyzickou, logickou, datovou a kognitivní vrstvu a operace mohou mít logické, fyzické nebo kognitivní účinky. Historicky je dobré uvést Morrisův červ, Estonsko, Gruzii, Stuxnet, ukrajinskou energetiku, NotPetya, SolarWinds a Ukrajinu po roce 2022 jako vývoj od zranitelnosti sítí přes DDoS, sabotáž a dodavatelské řetězce až po propojení kybernetických, informačních a konvenčních operací. Aktéry jsou státy, APT skupiny, proxy, kyberkriminálníci, hacktivisté, teroristické organizace využívající internet, firmy i dobrovolníci. Atribuce je proces přisouzení útoku, který má technickou, operační, strategicko-zpravodajskou a politicko-právní rovinu; IP adresa sama pachatele neprokazuje. Odstrašení znamená přesvědčit protivníka, že útok se nevyplatí, a funguje přes trest, odepření a odolnost. Mezinárodní právo platí i v kyberprostoru, ale sporná je aplikace na konkrétní situace; Tallinn Manual je nezávazná expertní studie. Netwar je síťově vedený konflikt, který může kyberkonflikt doprovázet přes decentralizaci, informační kampaně a swarming.}

\zdroje{Přednáškový materiál \emph{3.) Kyberválka (LONG)}; přiložené PDF a BSS poznámky; Tallinn Manual jako akademický rámec; NATO a EU dokumenty k odpovědnému chování a kolektivní reakci; NÚKIB k APT31 a APT28; CISA k Volt Typhoon a Salt Typhoon; NATO CCDCOE k Ukrajině.}
...
\priklad{Aktuální příklad z praxe - Synnovis a zdravotnictví: v červnu 2024 zasáhl ransomware poskytovatele laboratorních služeb Synnovis, který zpracovával krevní testy a patologické služby pro části NHS v jihovýchodním Londýně. Cílem tedy nebyla přímo "státní nemocniční síť", ale významný dodavatel, na němž nemocnice závisely. Dopad byl fyzický a společenský: odkládání vyšetření a operací, omezení laboratorních výsledků, problémy s transfuzními službami a přechod na náhradní postupy. NHS a Synnovis zároveň řešily data, komunikaci s pacienty, obnovu služeb a spolupráci s NCSC a policií. Ke zkoušce: u kritické infrastruktury nejde jen o ztrátu dat, ale o ztrátu schopnosti poskytovat péči; dodavatelský řetězec může být stejně kritický jako vlastní nemocniční systém.}

\priklad{Aktuální příklad z praxe - Volt Typhoon jako připravený přístup: společná upozornění CISA a partnerů popsala čínským státem podporovaného aktéra Volt Typhoon, který si udržoval přístup v prostředích kritické infrastruktury a používal living-off-the-land techniky. Pointa pro KI je, že útočník nemusí infrastrukturu hned sabotovat. Může mapovat energetiku, vodu, dopravu nebo komunikace a držet možnost budoucí aktivace v politické nebo vojenské krizi. Ke zkoušce: ochrana KI musí řešit i tichou perzistenci a přípravu bojiště, ne jen viditelné výpadky.}

\priklad{Aktuální příklad z praxe - satelitní infrastruktura: útok na službu Viasat v době zahájení ruské invaze proti Ukrajině ukázal, že komerční satelitní služby mohou mít vojenský i civilní význam. ENISA Space Threat Landscape 2025 upozorňuje, že komerční satelity čelí hrozbám v celém životním cyklu, včetně dodavatelských rizik, slabé konfigurace, omezené viditelnosti, lidské chyby a sofistikovaných útoků. Doprava, navigace, energetika, komunikace i armáda mohou záviset na satelitních službách, takže narušení může mít přeshraniční kaskádové dopady. Ke zkoušce: kritická infrastruktura dnes nekončí na území státu; může sahat do cloudu, satelitů a globálních dodavatelů.}
...
\begin{itemize}
  ...
  \item \textbf{17}: APT31, Volt Typhoon, Salt Typhoon, APT28/TP-Link, NoName057(16), Ukrajina a AI jako trendy kyberkonfliktu pod prahem ozbrojeného konfliktu.
  \item \textbf{18}: Synnovis/NHS, Volt Typhoon, satelitní infrastruktura podle ENISA a modelový příklad vodárenské společnosti.
...
\begin{itemize}
  \item \textbf{Skutečné případy z oficiálních zdrojů}: APT31/MZV ČR, DDoS vlna Q1 2026, Volt Typhoon, Salt Typhoon, APT28/TP-Link, NoName057(16), ukrajinská kybernetická obrana podle CCDCOE, Synnovis/NHS, Operation Endgame, First VPN, Cryptomixer/AudiA6, ÚOOÚ kontroly biometrické docházky a realitně-investičního zpracování údajů, Avast/Jumpshot a stanovisko EDPB k AI modelům.
