...
Vedle toho existuje speciální \textbf{stav kybernetického nebezpečí} podle zákona o kybernetické bezpečnosti. Je to mimořádný nástroj pro závažné ohrožení kybernetické bezpečnosti, které nelze účinně zvládnout běžnými prostředky. Stav kybernetického nebezpečí vyhlašuje Národní úřad pro kybernetickou a informační bezpečnost, tedy Úřad ve smyslu zákona č. 264/2025 Sb., na své úřední desce. Vyhlašuje se na nezbytně nutnou dobu, nejvýše na 30 dnů; prodloužení je možné jen v zákonných mezích tak, aby celková doba nepřekročila 60 dnů. Nejde o ústavní krizový stav jako nouzový stav, ale o sektorový kybernetický režim umožňující rychlejší a silnější opatření vůči dotčeným systémům a subjektům.
...
\priklad{Aktuální příklad z praxe - od incidentu k atribuci APT31: u kampaně proti MZV ČR nejprve proběhlo technické zjištění kompromitace a analýza dopadu na neutajovanou síť. Následně se zapojil NÚKIB a české zpravodajské služby, které skládaly technické stopy, zpravodajské poznatky a kontext cílů. Teprve potom následovalo strategické a politické posouzení, zda je veřejná atribuce vhodná, co pro ni lze zveřejnit a jaký bude diplomatický dopad. Vláda 28. 5. 2025 rozhodla o veřejné atribuci Čínské lidové republice, MZV vydalo politické odsouzení a následovala solidarita EU, NATO a partnerů. Ke zkoušce: technická atribuce, právní přičitatelnost a politická veřejná atribuce nejsou totéž; bezpečnostní systém funguje jako řetězec techniky, zpravodajství, vlády a diplomacie.}

\priklad{Aktuální příklad z praxe - DDoS vlna v Q1 2026: NÚKIB ve čtvrtletním přehledu za první čtvrtletí 2026 uvedl přes 70 evidovaných incidentů a výrazný nárůst způsobený hlavně lednovou vlnou DDoS útoků proruských hacktivistických skupin. U jednotlivé napadené služby nejprve reaguje provozovatel: filtruje provoz, komunikuje s poskytovatelem konektivity, zapojuje CERT/CSIRT a hlásí incident, pokud spadá do příslušného režimu. NÚKIB z takových hlášení a vlastních poznatků vytváří situační přehled, sdílí doporučení a varuje další subjekty; policie může vstoupit, pokud jsou dány znaky trestné činnosti. Ke zkoušce: ne každý DDoS je krizový stav nebo strategická eskalace, ale vlna menších útoků může vyžadovat koordinovaný situační přehled a sdílení informací na úrovni státu.}
...
Současné trendy je lepší vysvětlit jako změnu logiky konfliktu, ne jako seznam technik. Většina dnešních státních kybernetických operací nesměřuje k okamžitému fyzickému zničení. Častější je působení \textbf{pod prahem ozbrojeného konfliktu}: dlouhodobá špionáž, získání přístupu pro budoucí využití, krádeže přihlašovacích údajů, mapování kritické infrastruktury, DDoS, ovlivňování, zveřejňování odcizených informací a narušování služeb v šedé zóně. Takové operace mohou být nepřátelské a strategicky závažné, ale právně a politicky obvykle nejsou automaticky ozbrojeným útokem.

\priklad{Aktuální příklad z praxe - APT31 proti MZV ČR jako šedá zóna: česká veřejná atribuce z května 2025 popsala dlouhodobou kyberšpionážní kampaň proti neutajované síti MZV ČR od roku 2022. Cílem byly diplomatické informace a instituce kritické infrastruktury státu, nikoli fyzické zničení systému. Technicky šlo o kompromitaci sítě, strategicky o cizí zpravodajské působení a politicky o důvod k veřejné atribuci a diplomatickému odsouzení. Ke zkoušce: závažná státní kyberšpionáž může být otázkou národní bezpečnosti, ale sama o sobě obvykle není kyberválkou.}

Druhý trend je \textbf{pre-positioning} v kritické infrastruktuře. Útočník nemusí chtít infrastrukturu hned vypnout. Může si dlouhodobě získat a udržovat přístup, mapovat prostředí a připravit možnost zásahu pro budoucí krizi. Společná upozornění CISA a partnerských orgánů k aktérovi Volt Typhoon popisují právě tento vzorec: aktér spojovaný s ČLR cílil na americkou kritickou infrastrukturu a používal techniky \emph{living off the land}, tedy legitimní systémové nástroje a administrátorské funkce, které ztěžují detekci. Vojensky se tomu dá rozumět jako přípravě bojiště. Z hlediska odstrašení odepřením je odpovědí segmentace, monitoring administrátorských aktivit, správa identit, inventarizace aktiv, omezení laterálního pohybu a schopnost obnovy. Smysl obrany není jen zabránit průniku, ale odebrat útočníkovi očekávaný strategický efekt.

\priklad{Aktuální příklad z praxe - Volt Typhoon: podle CISA a partnerů šlo o kompromitaci a udržování přístupu v prostředích kritické infrastruktury, nikoli primárně o okamžité vypnutí služby. Příklad ilustruje, že kyberoperace může být tichá příprava budoucího nátlaku: stát v krizi ví, že protivník může mít přístup do energetiky, vody, dopravy nebo komunikací. Ke zkoušce: odstrašení v kyberprostoru není jen hrozba trestem, ale i schopnost udělat skrytý přístup nepoužitelným.}

Třetí trend je přesun zájmu k \textbf{telekomunikacím, cloudu a identitám}. Kampaň označovaná v bezpečnostní komunitě jako Salt Typhoon, popsaná CISA a partnerskými státy, ukazuje, proč jsou páteřní telekomunikační sítě strategickým zpravodajským cílem. Nejde jen o koncové počítače. Hodnotu mají provozní údaje, komunikace významných osob, metadata, správcovské účty, cloudová prostředí, identity provider a rozhraní pro správu infrastruktury. Kompromitace důvěryhodného poskytovatele umožňuje sledovat více cílů najednou a obcházet běžnou hranici mezi jednotlivými organizacemi.

Čtvrtý trend je zneužívání \textbf{okrajových zařízení a infrastruktury třetích osob}. NÚKIB v dubnu 2026 upozornil na kompromitaci routerů TP-Link ruským státním aktérem APT28. Podle tohoto upozornění aktér využíval zranitelnost CVE-2023-50224 v modelech TP-Link a kompromitovaná zařízení sloužila k přesměrování provozu a získávání přístupových údajů. Důležitá pointa není jen konkrétní značka routeru, ale atribuce: zdrojová IP adresa může patřit domácnosti nebo malé firmě, jejíž router útočník ovládl. Vlastník zařízení tedy nemusí být skutečný útočník. To je přesně důvod, proč se atribuce nesmí stavět jen na IP adrese.

\priklad{Aktuální příklad z praxe - APT28 a routery TP-Link: NÚKIB popsal, že ruský státní aktér APT28 využil zranitelné routery k infrastrukturní operaci. Technicky šlo o okrajová zařízení, často mimo přímou kontrolu oběti; strategicky o maskování původu a možnost krást přihlašovací údaje. Ke zkoušce: kompromitovaná infrastruktura třetí osoby je typická překážka technické atribuce.}

Pátý trend je role \textbf{proxy aktérů a hacktivismu}. Proruské hacktivistické skupiny, zejména NoName057(16), podle NÚKIB dlouhodobě stojí za velkou částí DDoS útoků proti českým a evropským cílům. Nejde o sofistikovanou APT skupinu se špionážním přístupem; typické jsou spíše dostupné DDoS nástroje, mobilizace dobrovolníků, veřejné kanály, gamifikace útoků a silná komunikace o "úspěších". Dopad jednotlivého útoku může být krátkodobý, ale větší množství menších útoků může zahltit technickou obranu, helpdesk, krizovou komunikaci i veřejný prostor. Právě tady se potkává netwar a swarming: mnoho uzlů působí současně a vytváří politický a reputační tlak, i když nedochází k fyzickému zničení.

Šestý trend je \textbf{integrace kybernetických, informačních a konvenčních operací}. Válka Ruska proti Ukrajině ukazuje, že kyberoperace mohou předcházet kinetickým útokům, doprovázet je nebo na ně navazovat. Patří sem průzkum a špionáž, destruktivní malware, DDoS, narušování satelitní komunikace, zveřejňování odcizených dat, informační operace a útoky na důvěru. Útok na Viasat ukázal význam komerčních satelitních služeb, wipery ukázaly destruktivní složku a dlouhodobé kampaně proti ukrajinským institucím ukázaly vytrvalost. NATO CCDCOE v roce 2026 zdůraznilo, že ukrajinská kyberobrana se opírá také o nestátní aktéry, dobrovolníky, soukromé bezpečnostní firmy, cloudové poskytovatele a veřejně-soukromá partnerství. To zvyšuje odolnost, ale zároveň vytváří roztříštěnou odpovědnost a závislost státu na soukromých technologiích.

Sedmý trend je \textbf{AI jako zesilovač}, ne magická autonomní zbraň. Reálně pomáhá zrychlovat tvorbu phishingových textů a překladů, personalizovat sociální inženýrství, analyzovat velké objemy odcizených dat, vytvářet falešné audio, video a profily, pomáhat s průzkumem, skriptováním a hledáním zranitelností. Na obranné straně pomáhá s tříděním alertů, korelací logů a rychlejší analýzou. Dosavadní trend je hlavně zesílení rychlosti, rozsahu a přesvědčivosti známých metod. Bez spolehlivých důkazů není vhodné mluvit o plně autonomní kyberválce vedené AI.

Osmý trend je posilování obrany: threat intelligence, rychlé mezinárodní sdílení indikátorů, kolektivní atribuce, sankce, trestní stíhání, rozbíjení infrastruktury, zero trust, ochrana identit, ochrana OT a satelitních systémů, cvičení vzájemné kybernetické podpory, kontinuita služby a zapojení soukromého sektoru. NATO navíc buduje nové struktury a v odborné debatě se objevuje NATO Integrated Cyber Defence Centre jako součást snahy lépe koordinovat kybernetickou obranu v alianci.

\zkouska{Jak současné trendy říct u zkoušky: "Dnešní kyberkonflikt se nejčastěji odehrává pod prahem války. Státy a jejich proxy aktéři sbírají informace, mapují infrastrukturu, drží si přístup pro budoucí krizi, útočí na identity, cloud, telekomunikace a dodavatelské služby, využívají hacktivisty pro viditelný tlak a kombinují technické operace s informačními. Ukrajina ukazuje propojení kybernetických, konvenčních a soukromých kapacit. AI zatím hlavně zrychluje známé metody. Obrana proto stojí na odolnosti, sdílení informací, ochraně identit, segmentaci, obnově služby a koordinované politické reakci."}
