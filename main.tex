...
\priklad{Aktuální příklad z praxe - APT31 a Ministerstvo zahraničních věcí ČR: česká vláda dne 28. 5. 2025 veřejně atribuovala dlouhodobou škodlivou kybernetickou kampaň proti jedné z neutajovaných sítí Ministerstva zahraničních věcí ČR Čínské lidové republice; podle NÚKIB a českých zpravodajských služeb za ní velmi pravděpodobně stála skupina APT31 spojovaná s čínskou zpravodajskou službou MSS. Referenčním objektem nebyl jen server, ale důvěrnost diplomatických informací, fungování zahraniční politiky a bezpečnost státu. Hrozbou byl zahraniční státní kyberšpionážní aktér, zranitelností kompromitovaná neutajovaná síť veřejné instituce a rizikem ztráta informací, oslabení důvěry a politický tlak. Příklad ukazuje průřezovost: vnější bezpečnost kvůli vazbě na cizí státní moc, vnitřní bezpečnost kvůli napadené české instituci, politický sektor kvůli zahraniční politice a informační sektor kvůli důvěrnosti komunikace. Zapojily se technická analýza NÚKIB, zpravodajské hodnocení BIS, VZ a ÚZSI, vláda, MZV a spojenci. Ke zkoušce si z toho odnes: kyberšpionáž může být vážná národněbezpečnostní operace, ale není automaticky kyberválka; krásně ale ukazuje referenční objekt, hrozbu, riziko, sektory i bezpečnostní politiku v praxi.}
