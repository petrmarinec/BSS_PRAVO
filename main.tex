...
Datové schránky upravuje zákon o elektronických úkonech a autorizované konverzi dokumentů (č. 300/2008 Sb.). Slouží k elektronickému doručování a k činění úkonů vůči orgánům veřejné moci. Informační systém datových schránek spravuje DIA a provozuje jej Česká pošta. Datová zpráva je dodána do schránky okamžikem dodání, doručena přihlášením oprávněné osoby, a pokud se osoba nepřihlásí, nastupuje fikce doručení zpravidla po 10 dnech.
